...
using TicketTrader.Identity.Models.Account;
using TicketTrader.Identity.Services.Account;
...
namespace TicketTrader.Identity.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IAuthenticationSchemeProvider schemesProvider,
            IClientStore clientStore)
        {
            ...
            _account = new AccountService(interaction, httpContext, schemesProvider, clientStore);
        }
