...
export class OrderDeliveriesService {
  ...
  getSelectedDeliveryOption(clientId: string, orderId: string): Observable<OrderDeliveryDto> {
  ...
  selectDeliveryOption(clientId: string, orderId: string, optionId: string): Observable<boolean> {
