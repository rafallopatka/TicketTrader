...
{
    public class OrderCommitedEventHandler : IEventHandler<OrderCommitedEvent>
    {
        ...
        public OrderCommitedEventHandler(IRepository<Order> orderRepository, 
        ...
        public async Task Handle(OrderCommitedEvent domainEvent)
        {
